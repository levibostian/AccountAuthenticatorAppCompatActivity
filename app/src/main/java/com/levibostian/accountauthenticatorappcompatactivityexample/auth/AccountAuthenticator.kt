package com.levibostian.accountauthenticatorappcompatactivityexample.auth
...
import com.levibostian.accountauthenticatorappcompatactivityexample.activity.AccountAuthenticatorActivity
...
class AccountAuthenticator(private val context: Context): AbstractAccountAuthenticator(context) {
    ...
    companion object {
        ...
        const val ACCOUNT_TYPE = "com.levibostian.accountauthenticatorappcompatactivityexample"
    }
    ...
    private fun getAuthenticatorActivityIntentBundle(response: AccountAuthenticatorResponse): Bundle {
        val intent = AccountAuthenticatorActivity.getIntent(context).apply {
